...
export const INTERNAL_PATHS = {
	 ...
	 * CARIBBEAN
	 */
	CARIBBEAN_DEFAULT: `${ROUTES_PATHS.CARIBBEAN.DEFAULT}`,
	/**
	 * CARIBBEAN - SHOP
	 */
	CARIBBEAN_SHOP_DEFAULT: `${ROUTES_PATHS.CARIBBEAN.SHOP.DEFAULT}`,
	CARIBBEAN_SHOP_CHECKOUT: `${ROUTES_PATHS.CARIBBEAN.SHOP.CHECKOUT}`,
	/**
	 * ASESORI - INSURANCE
	 */
	ASESORI_INSURANCE_DEFAULT: `${ROUTES_PATHS.CARIBBEAN.INSURANCE.DEFAULT}`,
	ASESORI_INSURANCE_RESULTS: `${ROUTES_PATHS.CARIBBEAN.INSURANCE.RESULTS}`,
	/**
	 * Server
	 */
...
export const INTERNAL_ROUTES = {
	 ...
	 * CARIBBEAN
	 */
	CARIBBEAN_DEFAULT: `/${INTERNAL_PATHS.CARIBBEAN_DEFAULT}`,
	/**
	 * CARIBBEAN - SHOP
	 */
	CARIBBEAN_SHOP_DEFAULT: `/${INTERNAL_PATHS.CARIBBEAN_SHOP_DEFAULT}`,
	CARIBBEAN_SHOP_CHECKOUT: `/${INTERNAL_PATHS.CARIBBEAN_SHOP_DEFAULT}/${INTERNAL_PATHS.CARIBBEAN_SHOP_CHECKOUT}`,
	/**
	 * ASESORI - INSURANCE
	 */
